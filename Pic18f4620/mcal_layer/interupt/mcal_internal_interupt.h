 /* 
 * File:   mcal_intiernal_interupt.h
 * Author: T-BOX
 *
 * Created on September 10, 2023, 4:11 AM
 */

#ifndef MCAL_INTIERNAL_INTERUPT_H
#define	MCAL_INTIERNAL_INTERUPT_H
...
#endif	/* MCAL_INTIERNAL_INTERUPT_H */
